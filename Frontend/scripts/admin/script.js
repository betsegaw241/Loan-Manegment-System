...
document
  .querySelector(".borrowers")
  .addEventListener("click", displayBorrowers);

document
  .querySelector(".loan_plan")
  .addEventListener("click", displayLoanPlans);
...
const loanPlans_container = document.querySelector(".loanPlans__container");
...
if (window.matchMedia("(min-width: 700px)").matches) {
  ...
  loanPlans_container.classList.add("view");
...
function displayLoanPlans() {
  if (window.matchMedia("(max-width: 700px)").matches) {
    ...
    card_container.classList.add("view");
    loans_container.classList.add("view");
    loanPlans_container.classList.remove("view");
    borrowers_container.classList.add("view");
  } else {
    users_container.classList.add("view");
    card_container.classList.add("view");
